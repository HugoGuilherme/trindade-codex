package br.com.trindade.project.core.security;
...
import br.com.trindade.project.core.exceptions.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
	...
	public TokenVO createAccessToken(String username, Long id,  List<String> roles, Perfil perfil) {
		Date now = new Date();
		Date validity = new Date(now.getTime() + validityInMilliseconds);
		var accessToken = getAccessToken(username, roles, now, validity);
		var refreshToken = getRefreshToken(username, roles, now);

		return new TokenVO(username, id, true, now, validity, accessToken, refreshToken, perfil);
	}

	public TokenVO refreshToken(String refreshToken, Perfil perfil, Long id) {
		...
		return createAccessToken(username, id,  roles, perfil);
	}
